...
@Service
public class getUserRoleByIdUseCase {
    private final UserRoleRepository repository;
    public getUserRoleByIdUseCase(UserRoleRepository repository) { this.repository = repository; }
    public UserRoleDTO execute(Long id) { return repository.getById(id); }
}
